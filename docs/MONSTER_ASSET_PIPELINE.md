...
The completed studies are bat, hobgoblin, ice monster, kestrel, orc, rattlesnake, and snake. They are available in the standalone browser model viewer. The gameplay renderer does not yet select these GLBs for monster entities.
