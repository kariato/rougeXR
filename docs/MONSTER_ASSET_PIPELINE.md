...
The complete 26-monster roster consists of aquator, bat, black unicorn, centaur, dragon, emu, griffin, hobgoblin, ice monster, jabberwock, kestrel, leprechaun, medusa, nymph, orc, phantom, quagga, rattlesnake, snake, troll, venus flytrap, vampire, wraith, xeroc, yeti, and zombie. They are available in the standalone browser model viewer. Live-game integration has begun with Kestrel and bat; remaining monsters still use the procedural fallback until registered individually.
