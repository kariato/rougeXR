...
The completed studies are bat, centaur, hobgoblin, ice monster, kestrel, leprechaun, orc, rattlesnake, snake, and zombie. They are available in the standalone browser model viewer. The gameplay renderer does not yet select these GLBs for monster entities.
