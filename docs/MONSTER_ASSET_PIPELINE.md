...
The completed studies are aquator, bat, centaur, hobgoblin, ice monster, kestrel, leprechaun, nymph, orc, phantom, quagga, rattlesnake, snake, troll, venus flytrap, wraith, xeroc, yeti, and zombie. They are available in the standalone browser model viewer. The gameplay renderer does not yet select these GLBs for monster entities.
