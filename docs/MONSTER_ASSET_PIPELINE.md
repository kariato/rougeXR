...
The completed studies are aquator, bat, black unicorn, centaur, emu, griffin, hobgoblin, ice monster, kestrel, leprechaun, medusa, nymph, orc, phantom, quagga, rattlesnake, snake, troll, venus flytrap, vampire, wraith, xeroc, yeti, and zombie. They are available in the standalone browser model viewer. The gameplay renderer does not yet select these GLBs for monster entities.
