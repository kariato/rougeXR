...
Phase 14 first-person presentation has begun: every generated room now stores a deterministic visual theme and non-blocking decoration plan at creation time. The remaining work enlarges and simplifies the gameplay UI, connects animated monsters, replaces flat surfaces with themed materials and lighting, adds recognizable structure and props, and adds presentation-only movement and combat feedback. Only decorations on disclosed cells reach the renderer.
