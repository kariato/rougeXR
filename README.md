...
Phase 14 first-person presentation has begun: every generated room stores a deterministic visual theme and non-blocking decoration plan at creation time. All seven current decoration kinds, all nine collectible item categories, and all 26 Rogue monsters now have original Blender GLBs loaded from disclosed observations with primitive fallbacks. The browser now opens with a dominant first-person viewport, compact observation-backed HUD, and collapsible tools panel. Remaining visual work consolidates creature assets and combat clips, improves structural materials and lighting, and adds event-driven combat feedback. Only disclosed cells and entities reach the renderer.
