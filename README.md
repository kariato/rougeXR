...
Phase 14 first-person presentation has begun: every generated room stores a deterministic visual theme and non-blocking decoration plan at creation time. All seven current decoration kinds, all nine collectible item categories, and all 26 Rogue monsters now have original Blender GLBs loaded from disclosed observations with primitive fallbacks. The browser opens with a dominant first-person viewport, compact observation-backed HUD, and collapsible tools panel. Room surfaces now vary deterministically with dungeon stone, cave rock, crypt masonry, store wood, and treasure inlay patterns and theme-aware lighting. Remaining visual work consolidates creature assets and combat clips, builds structural room silhouettes and authored environment kits, and adds event-driven combat feedback. Only disclosed cells and entities reach the renderer.
