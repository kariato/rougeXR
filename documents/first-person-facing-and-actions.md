...
A resolved `visibleDefeat` for the player starts a 1.4-second first-person fall. The eye height eases from standing height to near the floor, the camera rolls and tilts upward, and the hand and equipped weapon drop out of the active pose. The final ground-level, upward-looking perspective remains clamped after the animation. In orbit and tabletop modes, the rogue GLB continues to play its exported death clip. Starting or loading a new presentation clears the death pose.
