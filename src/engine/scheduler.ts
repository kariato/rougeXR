...
export const KNOWN_EFFECT_IDS = new Set(['before', 'after', 'fixture', 'runners', 'doctor', 'stomach', 'swander', 'rollwand', 'unconfuse', 'sight', 'nohaste', 'land', 'unsee', 'turnSee', 'visuals', 'comeDown']);
