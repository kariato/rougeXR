...
const model = requestedModel === 'aquator' || requestedModel === 'bat' || requestedModel === 'centaur' || requestedModel === 'ice-monster' || requestedModel === 'kestrel' || requestedModel === 'leprechaun' || requestedModel === 'orc' || requestedModel === 'quagga' || requestedModel === 'rattlesnake' || requestedModel === 'snake' || requestedModel === 'zombie' ? requestedModel : 'hobgoblin';
