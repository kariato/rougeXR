...
const model = requestedModel === 'bat' || requestedModel === 'ice-monster' || requestedModel === 'kestrel' || requestedModel === 'leprechaun' || requestedModel === 'orc' || requestedModel === 'rattlesnake' || requestedModel === 'snake' || requestedModel === 'zombie' ? requestedModel : 'hobgoblin';
