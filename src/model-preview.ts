...
const model = requestedModel === 'aquator' || requestedModel === 'bat' || requestedModel === 'black-unicorn' || requestedModel === 'centaur' || requestedModel === 'dragon' || requestedModel === 'emu' || requestedModel === 'griffin' || requestedModel === 'ice-monster' || requestedModel === 'jabberwock' || requestedModel === 'kestrel' || requestedModel === 'leprechaun' || requestedModel === 'medusa' || requestedModel === 'nymph' || requestedModel === 'orc' || requestedModel === 'phantom' || requestedModel === 'quagga' || requestedModel === 'rattlesnake' || requestedModel === 'snake' || requestedModel === 'troll' || requestedModel === 'venus-flytrap' || requestedModel === 'vampire' || requestedModel === 'wraith' || requestedModel === 'xeroc' || requestedModel === 'yeti' || requestedModel === 'zombie' ? requestedModel : 'hobgoblin';
